...
void SpeedyMergeNtuple(){
  ...
  // Run 4c Main Samples
  //std::string dir_in = "/exp/uboone/data/users/uboonepro/SURPRISE/run4c_full_samples/BNB/";
  //std::string filename = "checkout_MCC9.10_Run4acd5_v10_04_07_20_BNB_nu_overlay_retuple_retuple_hist_4c.root";     is_data = false;  save_syst = true;
  //std::string filename = "checkout_MCC9.10_Run4a4c4d5_v10_04_07_13_BNB_dirt_overlay_surprise_reco2_hist_4c.root";  is_data = false;  save_syst = false;
  //std::string dir_in = "/pnfs/uboone/persistent/users/uboonepro/surprise/run4c_full_samples/wc_processed/BNB/";
  //std::string filename = "checkout_MCC9.10_Run4acd5_v10_04_07_14_BNB_beam_off_surprise_reco2_hist_4c.root";        is_data = true;  save_syst = false;
  //std::string filename = "checkout_MCC9.10_Run4acd5_v10_04_07_14_BNB_beam_on_surprise_reco2_hist_4c.root";         is_data = true;  save_syst = false;
  //std::string filename = "checkout_MCC9.10_Run45_v10_04_07_23_BNB_nuwro_overlay_surprise_reco2_hist_4c.root"; is_data = false;  save_syst = false;
  //std::string dir_out = "/exp/uboone/data/users/cthorpe/DIS/Lanpandircell/retupled/run4c/";

  // Run 4d Main Samples
  //std::string dir_in = "/exp/uboone/data/users/uboonepro/SURPRISE/run4d_full_samples/BNB/";
  //std::string filename = "checkout_MCC9.10_Run4acd5_v10_04_07_20_BNB_nu_overlay_retuple_retuple_hist_4d.root";     is_data = false;  save_syst = true;
  //std::string filename = "checkout_MCC9.10_Run4a4c4d5_v10_04_07_13_BNB_dirt_overlay_surprise_reco2_hist_4d.root";  is_data = false;  save_syst = false;
  //std::string dir_in = "/pnfs/uboone/persistent/users/uboonepro/surprise/run4d_full_samples/wc_processed/BNB/";
  //std::string filename = "checkout_MCC9.10_Run4acd5_v10_04_07_14_BNB_beam_off_surprise_reco2_hist_4d.root";        is_data = true;  save_syst = false;
  //std::string filename = "checkout_MCC9.10_Run4acd5_v10_04_07_14_BNB_beam_on_surprise_reco2_hist_4d.root";         is_data = true;  save_syst = false;
  //std::string dir_out = "/exp/uboone/data/users/cthorpe/DIS/Lanpandircell/retupled/run4d/";

  // Run 5 Main Samples
  //std::string dir_in = "/exp/uboone/data/users/uboonepro/SURPRISE/run5_full_samples/BNB/";
  ...
  //std::string filename = "checkout_MCC9.10_Run45_v10_04_07_23_BNB_nuwro_overlay_surprise_reco2_hist_5.root"; is_data = false;  save_syst = false;
  ...
  //std::string filename = "checkout_DetVar_Run45_v10_04_07_19_BNB_nu_overlay_cv_surprise_reco2_hist_4d.root";       is_data = false;  save_syst = false;
  //std::string filename = "checkout_DetVar_Run45_v10_04_07_19_BNB_nu_overlay_lya_surprise_reco2_hist_4d.root";      is_data = false;  save_syst = false;
  //std::string filename = "checkout_DetVar_Run45_v10_04_07_19_BNB_nu_overlay_lyd_surprise_reco2_hist_4d.root";      is_data = false;  save_syst = false;
  //std::string filename = "checkout_DetVar_Run45_v10_04_07_19_BNB_nu_overlay_lyr_surprise_reco2_hist_4d.root";      is_data = false;  save_syst = false;
  //std::string filename = "checkout_DetVar_Run45_v10_04_07_19_BNB_nu_overlay_recomb2_surprise_reco2_hist_4d.root";  is_data = false;  save_syst = false;
  ...
  //std::string filename = "checkout_DetVar_Run45_v10_04_07_19_BNB_nu_overlay_lyr_surprise_reco2_hist_5.root";      is_data = false;  save_syst = false;
